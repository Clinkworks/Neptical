...
public class GuiceJUnit4RunnerUnitTest {
	...
	public void canPassDependencyInstancesToTestMethods() throws Throwable{
		...
		assertTrue(GuiceJUnitTestModules.ASSERTION_DEPENDENCY.wasCalled()); //NOTE: This is loaded in the @Before method. This insures that Guice properly passed it into the dependent test
	}	
	...
	public static class MockTestThatNeedsSupportForNamedAnnotation{
		...
		public void testNamedConfiguration(@Named("String1") String string1, @Named("String2") String string2, AssertionDependency assertionDependency){
	...
	public static class MockTestFullIntegrationMethodLevelClassLevelConfigurations{
		...
		public void testMethodWithStringAndIntegerDependencys(String stringToInject, Integer integerToInject, AssertionDependency assertionDependency){
	...
	public static class MockTestWithBoundAnnotationDependency{
		...
		@Test
		public void testMethodWithUnConfiguredIntegerAndBoundInteger(@BindingAnnotationForIntegerConfig Integer leetInteger, Integer nullInteger, AssertionDependency assertionDependency){
	...
	//Test helpers - will do a bit of research and find better libraries for handling these
	//If I do decide to keep them I should probably externalize them to a different service
	//----------------------------------------------------------------------------------------
	...
	private static void runTestMethod(GuiceJUnit4Runner runnerInstance, Class<?> testClass, String testMethodName) throws Throwable{
		try{
