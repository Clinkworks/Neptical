...
import static clinkworks.neptical.util.Constants.DOT;
import static clinkworks.neptical.util.Constants.EMPTY_STRING;
import static clinkworks.neptical.util.Constants.RegexPatterns.ARRAY_AT_END;
import static clinkworks.neptical.util.Constants.RegexPatterns.ARRAY_SYNTAX;
import static clinkworks.neptical.util.Constants.RegexPatterns.ARRAY_SYNTAX_PATTERN;
